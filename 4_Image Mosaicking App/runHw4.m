...
% UNCOMMENT:  SELECTED CORNER POINTS
...
% test_pts_nx2 = [346.0000  312.0000; 356.0000  368.0000; 402.0000  676.0000; 216.0000  696.0000];
test_pts_nx2 = [ 160.0000  102.0000; 348.0000  310.0000; 390.0000  572.0000; 590.0000  506.0000];

% UNCOMMENT TO  SELECT POINTS using GINPUT
% fh3 = figure(); 
% imshow(orig_img);
...
% stitch three images
% imgc1 = im2single(imread('20210320_114347-min.jpg'));
% imgl1 = im2single(imread('20210320_114349-min.jpg'));
% imgr1 = im2single(imread('20210320_114351-min.jpg'));

imgc1 = im2single(imread('cs_center.png'));
imgl1 = im2single(imread('cs_left.png'));
imgr1 = im2single(imread('cs_right.png'));


% imgc1 = im2single(imread('20210320_114349.jpg'));
% imgl1 = im2single(imread('20210320_114347.jpg'));
% imgr1 = im2single(imread('20210320_114351.jpg'));

% You are free to change the order of input arguments
stitched_img = stitchImg(imgc1, imgl1, imgr1);
figure, imshow(stitched_img);
imwrite(stitched_img, 'cs_panorama.png');
